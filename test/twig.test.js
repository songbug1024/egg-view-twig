...
describe('test/egg-view-twig.test.js', () => {

  describe('render', () => {
    let app;
    before(() => {
      app = mm.app({
        baseDir: 'apps/twig-view',
      });
      return app.ready();
    });
    after(() => app.close());
    ...
    it('should render with cache', function* () {
      const cacheFile = path.join(fixtures, 'apps/twig-view/app/view/cache.twig');
    ...
    /* it('should render error', () => {
      return request(app.callback())
        .get('/error')
        .expect('Unable to find closing bracket \'%}\' opened near template position 2')
        .expect(200);
    });*/
  });
