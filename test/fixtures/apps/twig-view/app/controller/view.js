...
exports.renderWithLocals = function* (ctx) {
  yield ctx.render('locals.twig', {
    data: 'world',
  });
};

exports.include = function* (ctx) {
  yield ctx.render('include/index.twig');
};

exports.renderWithHelper = function* (ctx) {
  yield ctx.render('helper.twig');
};

exports.cache = function* (ctx) {
  yield ctx.render('cache.twig');
};

exports.htmlext = function* (ctx) {
  yield ctx.render('twig.html');
};

exports.error = function* (ctx) {
  try {
    yield ctx.render('error.twig');
  } catch (err) {
